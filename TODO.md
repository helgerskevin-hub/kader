...
- [ ] **Stop-loss is niet accuraat / niet in te vullen op eToro.** De door Kader berekende stop-loss kun je op eToro niet altijd zo invullen (eToro accepteert het niveau niet of rondt anders af). Hier een check inbouwen: valideren of de voorgestelde stop-loss binnen eToro's toegestane bereik/stappen valt en anders bijstellen of waarschuwen.
