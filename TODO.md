...
- [x] **Sync-status / "loop ik achter?"**: cloud-icoontje in de header dat met kleur laat zien of de gegevens actueel zijn (grijsgroen = net bijgewerkt, oranje = verouderd, rood = te oud of laatste poging mislukt). Tik erop voor het tijdstip van de laatste synchronisatie, een advies en een "Nu synchroniseren"-knop. Ververst ook automatisch zodra de app weer op de voorgrond komt. Tijdstip blijft bewaard tussen app-starts
